...
test.describe('Testing functionality to add and remove elements',() => {
    ...
    test('Add a single element and verify one delete button appears', async ({ page }) => {
    ...
    test('Add multiple elements and verify correct count appears', async ({ page }) => {
    ...
    test('Add multiple elements, delete some, verify correct count remains', async ({ page }) => {
