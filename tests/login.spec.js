...
test.describe('Login functionality', () => {
    ...
    test('User can login and logout successfully', async ({page}) => {
        ...
        await test.step('Login with valid credentials and verify success message', async () => {
    ...
    test('User cannot login with invalid credentials', async ({page}) => {
        ...
        await test.step('Attempt to login with invalid credentials and verify error message', async () => {
    ...
    test('User sees error when trying to login with empty fields', async ({page}) => {
        ...
        await test.step('Attempt to login with empty fields and verify error message', async () => {
    ...
    test('User cannot login with invalid username and valid password', async ({page}) => {
        ...
        await test.step('Attempt to login with invalid username and verify error message', async () => {
